    ...
    return (
        <div className="min-h-screen bg-jungle-900 flex items-center justify-center p-4">
            <div className="bg-ivory text-jungle-900 w-full max-w-md p-8 rounded-2xl shadow-2xl relative">
                <Link to="/" className="absolute top-4 left-4 text-jungle-900/50 hover:text-jungle-900 transition-colors">
                ...
                <div className="mt-6 text-center text-sm">
                    ...
                    <Link to="/register" className="font-bold text-earth-900 hover:underline">
                        Register Here
                    </Link>
                </div>
            </div>
