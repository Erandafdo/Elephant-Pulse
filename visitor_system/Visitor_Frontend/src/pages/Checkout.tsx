...
function CheckoutContent() {
    ...
    const val = parseFloat(searchParams.get("val") || "0");
    const count = parseInt(searchParams.get("count") || "1");
    const totalPrice = (val * count).toFixed(2);
    ...
    return (
        <div className="min-h-screen bg-ivory text-jungle-900">
            <nav className="p-6 border-b border-jungle-900/5">
                <Link to="/tickets" className="flex items-center gap-2 font-bold hover:text-earth-500">
            ...
            <div className="max-w-xl mx-auto px-6 py-12">
                ...
                <div className="bg-white p-6 rounded-2xl shadow-lg border border-earth-100 mb-8">
                    ...
                    <div className="flex justify-between items-center text-lg font-bold">
                        ...
                        <span>{priceStr.includes("LKR") ? `LKR ${totalPrice}` : `$${totalPrice}`}</span>
                    </div>
