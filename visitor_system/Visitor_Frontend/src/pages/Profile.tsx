        ...
        <main className="min-h-screen bg-ivory text-jungle-900 font-sans pb-20">
            <header className="bg-jungle-900 text-ivory p-8 pt-12 rounded-b-[3rem] shadow-2xl relative overflow-hidden">
                ...
                <div className="max-w-4xl mx-auto relative z-10 flex justify-between items-start">
                    <Link to="/" className="bg-ivory/10 hover:bg-ivory/20 p-2 rounded-full transition-colors backdrop-blur-md">
            ...
            <div className="max-w-4xl mx-auto px-6 mt-12 grid md:grid-cols-2 gap-12">
                ...
                >
                    <div className="flex justify-between items-center">
                        ...
                        <Link to="/tickets" className="text-xs font-bold bg-earth-500 text-jungle-900 px-3 py-1.5 rounded-lg hover:bg-earth-400 transition-colors shadow-md flex items-center gap-1">
                            + Buy New
                        </Link>
                    </div>
                    ...
                    <div className="bg-earth-500/10 p-6 rounded-2xl border border-earth-500/20">
                        ...
                        <p className="text-sm text-jungle-900/70">
                            You have <span className="font-bold text-jungle-900">{data.loyalty_points}</span> points.
                            Collect {500 - (data.loyalty_points % 500)} more to unlock the next Tier!
                        </p>
                        <div className="w-full bg-earth-100 h-2 rounded-full mt-4 overflow-hidden">
                            <div className="bg-earth-500 h-full transition-all duration-500" style={{ width: `${(data.loyalty_points % 500) / 5}%` }}></div>
                        </div>
                    </div>
                </motion.section>
                <motion.section
                ...
                >
                    <div className="flex justify-between items-center">
                        ...
                        <Link to="/timeline" className="text-sm font-bold text-emerald-700 hover:underline">
                            View Live Map
                        </Link>
                    </div>
